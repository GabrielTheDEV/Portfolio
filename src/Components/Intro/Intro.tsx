        ...
        <section className="w-screen h- flex items-center justify-center p-40 border-b ">
            <div className="flex flex-col items-center justify-center ">
                ...
                <div className="flex gap-8 p-10">
                    <button className="border-2 border-green-400 rounded py-3 px-10">Ver Projetos</button>
                    <button className="border-2 border-black rounded py-3 px-10 ">Baixar CV</button>
                </div>
            </div>
        </section>
