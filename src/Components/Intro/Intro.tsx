        ...
        <section className="w-screen h- flex items-center justify-center p-40 ">
            <div className="flex flex-col items-center justify-center ">
                ...
                <div className="my-4 lg:m-0 ">
                    ...
                    <h1 className="text-2xl lg:text-4xl font-bold bg-gradient-to-r from-emerald-500  via-green-500 to-cyan-400 bg-clip-text text-transparent ">Desenvolvedor Front end</h1>
                </div>
